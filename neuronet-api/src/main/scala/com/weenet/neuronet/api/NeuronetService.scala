package com.weenet.neuronet.api
...
object NeuronetService  {
  val TOPIC_NAME = "greetings"
}

/**
  * The Neuronet service interface.
  * <p>
  * This describes everything that Lagom needs to know about how to serve and
  * consume the NeuronetService.
  */
trait NeuronetService extends Service {
  ...
  override final def descriptor = {
    ...
    named("neuronet")
      ...
      .withTopics(
        topic(NeuronetService.TOPIC_NAME, greetingsTopic)
